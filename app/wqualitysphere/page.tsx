...
const cards = [
  ...
  { key: "whyTitle", descKey: "whyDesc", icon: CheckCircle2, color: "#1e6db5" },
  { key: "letsWorkTogether", descKey: "letsWorkTogetherDesc", icon: Handshake, color: "#1e6db5" },
] as const;
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Icon */}
          <div
            className="quality-icon mb-4 flex h-14 w-14 items-center justify-center rounded-xl"
            style={{ background: `${color}15` }}
          >
