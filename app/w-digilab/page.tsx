...
import { Code2, Palette, Lightbulb, Handshake, ArrowRight } from "@/components/icons";
...
const cards = [
  { key: "servicesTitle", descKey: "servicesTitleDesc", icon: Code2, color: "#1e6db5" },
  { key: "visualApproach", descKey: "visualApproachDesc", icon: Palette, color: "#1e6db5" },
  { key: "innovation", descKey: "innovationDesc", icon: Lightbulb, color: "#1e6db5" },
  { key: "togetherSuccess", descKey: "togetherSuccessDesc", icon: Handshake, color: "#1e6db5" },
] as const;
  ...
  return (
    <PageLayout title={t("title")} subtitle={t("subtitle")} eyebrow={t("eyebrow")} titleHighlight={t("titleHighlight")} heroImage="/images/brands/warticode.webp">
      <div ref={sectionRef}>
        ...
        <div className="wc-cta relative mt-14 overflow-hidden rounded-3xl px-8 py-20 sm:px-16 sm:py-24" style={{ background: "#0a0f1e" }}>
          {/* Background blobs */}
